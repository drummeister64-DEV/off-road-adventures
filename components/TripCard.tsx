...
export default function TripCard({ trip, priority = false }: TripCardProps) {
  ...
  return (
    <Link
      ...
      className="group block rounded-xl overflow-hidden bg-white/5 border border-orange-800/30 hover:border-orange-700/50 transition-all duration-300 hover:shadow-xl hover:shadow-black/40 hover:-translate-y-0.5"
    >
      {/* Cover image */}
