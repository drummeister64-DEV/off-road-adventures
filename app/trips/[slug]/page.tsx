    ...
    <div className="min-h-screen">
      ...
      <div className="relative h-[55vh] min-h-[400px]">
        ...
        <div className="absolute top-20 left-0 right-0 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link
            href="/trips"
            className="inline-flex items-center gap-1.5 text-xs text-slate-300 hover:text-white transition-colors drop-shadow-[0_1px_3px_rgba(0,0,0,0.8)]"
          >
        ...
        <div className="absolute bottom-0 left-0 right-0 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
          ...
          <p className="text-slate-300 flex items-center gap-1.5 text-sm">
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      <li key={stat.label} className="flex items-start gap-3">
                        <span className="mt-0.5 text-orange-500 shrink-0">{stat.icon}</span>
                        <div>
